...
geoloqi.init({
             clientId: "9b49d9736b9ce4d486433529bbec45f3",
             clientSecret: "eed2daf7681402837ee75eeafdd120bd",
             trackingProfile: "REALTIME",
...
btnSetProfile.addEventListener('click',function(){
                               alert(geoloqi.tracker.setProfile("LOGGING"));
                               });
...
button11.addEventListener('click',function(){
                          alert(geoloqi.tracker.canSwitchToProfile("LOGGING"));
                          });
