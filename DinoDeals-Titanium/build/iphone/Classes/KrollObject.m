 ...
 * Copyright (c) 2009-2011 by DinoDeals, Inc. All Rights Reserved.
...
//@interface DinoDealsObject : NSObject
//@end

@interface DinoDealsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DinoDealsObject class]])
		{
			for (NSString *key in [[(DinoDealsObject*)o modules] allKeys])
			{
