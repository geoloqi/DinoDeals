...
/**
 The base class for all DinoDeals modules
 */
...
/**
 DinoDeals Platform calls this method on startup.
 */
-(void)startup;

/**
 DinoDeals Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 DinoDeals Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 DinoDeals Platform calls this method on resume.
 @param sender The sender of the event.
 */
