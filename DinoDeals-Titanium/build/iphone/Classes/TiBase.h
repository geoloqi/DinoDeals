...
// in simulator we redefine to format for DinoDeals Developer console
...
{\
	NSString * exceptionName = [@"org.dinodeals." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dinodeals";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIDinoDealsNativeItemNone = -1, 
	UIDinoDealsNativeItemSpinner = -2,
	UIDinoDealsNativeItemProgressBar = -3,
	
	UIDinoDealsNativeItemSlider = -4,
	UIDinoDealsNativeItemSwitch = -5,
	UIDinoDealsNativeItemMultiButton = -6,
	UIDinoDealsNativeItemSegmented = -7,
	
	UIDinoDealsNativeItemTextView = -8,
	UIDinoDealsNativeItemTextField = -9,
	UIDinoDealsNativeItemSearchBar = -10,
	
	UIDinoDealsNativeItemPicker = -11,
	UIDinoDealsNativeItemDatePicker = -12,
	
	UIDinoDealsNativeItemInfoLight = -13,
	UIDinoDealsNativeItemInfoDark = -14,
	
	UIDinoDealsNativeItemDisclosure = -15,
	
	UIDinoDealsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DinoDeals instances of
