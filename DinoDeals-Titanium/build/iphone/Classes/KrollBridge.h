...
@interface DinoDealsObject : KrollCoverageObject {
#else
@interface DinoDealsObject : KrollObject {
#endif
@private
...
extern NSString * DinoDeals$ModuleRequireFormat;
